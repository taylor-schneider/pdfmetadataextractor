...
def pdf_has_text(file_path, significance_level=.95):
    # This is an abstraction which will call our best method for detecting text
    return pfd_has_ocr_text3(file_path, significance_level)
